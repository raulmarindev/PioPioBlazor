namespace PioPioBlazor.Components
{
    public class TagSelectorStyle
    {
        ...
        {
            SelectorClass = "block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline mb-8 md:w-5/12",
            SelectedTagClass = "bg-blue-300 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-full cursor-pointer",
